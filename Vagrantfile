...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "rabbitmq_1" do |rabbitmq_1|
	...
	#rabbitmq_1.vm.network "forwarded_port", guest: 8080, host: 8081
  ...
  config.vm.define "rabbitmq_2" do |rabbitmq_2|
	...
	#rabbitmq_2.vm.network "forwarded_port", guest: 8080, host: 8082
  ...
  config.vm.define "rabbitmq_3" do |rabbitmq_3|
	...
	#rabbitmq_3.vm.network "forwarded_port", guest: 8080, host: 8082
